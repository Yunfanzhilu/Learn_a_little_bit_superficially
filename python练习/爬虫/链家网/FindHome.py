...
#房间价格
findValue = re.compile(r'<div class="totalPrice totalPrice2"><i> </i><span class="">(.*?)</span>')
#房间细节
findJudge = re.compile(r'houseIcon"></span>(.*?)<',re.S)
#房间m^2单价
findVpm2 = re.compile(r'<span>(.*?)元/平</span>')
#大区
